...
class TestPdfOutput(unittest.TestCase):
    ...
    def test_generate_a_row_online_mode(self):
        ...
        received_result = pdf_output.generate_a_row(row_content=self.test_row, header_name=self.header_name,
    ...
    def test_generate_a_row_short_case_online(self):
        ...
        received_result = pdf_output.generate_a_row(row_content=self.test_row[:15], header_name=self.header_name,
                                                    max_line_len=self.max_line_len, online_mode_flag=True)
        self.assertEqual(expected_result, received_result)
    ...
    def test_link_separator_online_mode(self):
        ...
        received_result = pdf_output.link_separator(link=self.link, header_name=self.header_name,
                                                    max_line_len=self.max_line_len, online_mode_flag=True)
        self.assertEqual(expected_result, received_result)
    ...
    def test_link_separator_short_case_online(self):
        ...
        received_result = pdf_output.link_separator(link=self.link[:23], header_name=self.header_name,
                                                    max_line_len=self.max_line_len, online_mode_flag=True)
        self.assertEqual(expected_result, received_result)
    ...
    @patch("pdf_output.link_separator")
    @patch("pdf_output.generate_a_row")
    def test_get_data_list(self, generate_a_row_mock, link_separator_mock):
        ...
        received_result = pdf_output.get_data_list(item=example_data, online_mode=online_mode_flag,
